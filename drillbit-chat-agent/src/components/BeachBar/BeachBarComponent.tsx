...
import { BeachBarItem } from "./BeachBarItem";
      ...
      <div className="flex flex-wrap gap-2.5 mt-1">
        ...
        {drinks &&
          drinks.map((drink) => (
            ...
            >
              <div
                className="rounded-lg w-[70px] h-[140px] flex flex-col border-2 border-[#EAEAE] drop-shadow-lg hover:border-[#e57931] hover:bg-[#e5c0a8]">
