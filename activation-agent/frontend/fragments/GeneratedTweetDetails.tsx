  ...
  <div class="text-center">
    ...
    >
      ...
      <a
        ...
        class="flex items-center text-primary font-medium mb-10 text-lg no-underline hover:opacity-80 transition-opacity duration-300"
      ...
      >
        ...
        <span class="hide-on-request">Pick</span>
      </button>
    </form>
  </div>
);
